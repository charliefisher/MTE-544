...
class RobotController:
    ...
    def _receive_odom(self, msg: Odometry) -> None:
        ...
        # self._cur_heading = 2*np.arccos(msg.pose.pose.orientation.w)
        # self._logger.info('cur heading {} {}'.format(self._cur_heading, 2*np.arccos(msg.pose.pose.orientation.w)))
    ...
    def cur_position(self) -> Point:
        ...
        # cur_pos_map_np = self._tf_map_odom@self._tf_odom_bf@cur_pos_odom_np
    ...
    def run(self) -> None:
        ...
        # ang_err = math.fmod(ang_err, math.pi)
